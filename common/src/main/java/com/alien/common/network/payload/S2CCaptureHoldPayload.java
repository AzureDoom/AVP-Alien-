 ...
 *
 * <p>Carries the mob's network entity id and the holder's network entity id; a {@code holderId} of {@code -1} means the
 ...
 */
public record S2CCaptureHoldPayload(int mobId, int holderId) implements CustomPacketPayload {
