package com.alien.common.gameplay.hive2.util;

import com.alien.common.registry.tag.AlienEntityTypeTags;
import net.minecraft.world.entity.EntityType;

/**
 * Caste-disposition ranks used by leader-pick comparators across the hive2 system. Higher rank wins. Empress (5)
