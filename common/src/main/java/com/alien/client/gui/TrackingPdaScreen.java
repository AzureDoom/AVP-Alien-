 ...
 * row echoes her position to chat and closes the screen. Populated from {@link TrackedQueenRow}s pushed by the server in
 * reply to the PDA's request; opened by {@code AlienClientPacketListener#handleTrackedQueens}.
 */
