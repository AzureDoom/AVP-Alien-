...
public class VentActions {
    ...
    public static final Action<Xenomorph> CREATE_VENT = BLibAction.<Xenomorph>builder("CreateVentAction")
        ...
        .addPlanTimePrecondition(VentSensors.CAN_CREATE_VENT.key(), Expressions.Boolean.isTrue())
        .addPlanTimePrecondition(VentSensors.HAS_VENT_TARGET.key(), Expressions.Boolean.isTrue())
