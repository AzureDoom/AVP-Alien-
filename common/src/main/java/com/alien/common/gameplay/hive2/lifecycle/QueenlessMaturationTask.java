 ...
 * {@link com.alien.common.gameplay.hive2.faction.LineageInvariantTask#scanAllWithLifecycle}.
 * <p>
 ...
 * {@link com.alien.common.gameplay.hive2.location.HiveLocationLeadership}.</li>
 ...
 * {@link com.alien.common.gameplay.hive2.empress.EmpressEmergenceTask} handles empress promotion in multi-location
 * lineages).</li>
 * </ul>
 * <p>
    ...
    private static void advanceLocation(
        ...
        if (!leaderId.equals(location.queenlessLeaderSnapshot())) {
            ...
            if (entity != null && !faction.membership().hasMember(com.blib.api.common.faction.v1.FactionMember.entity(entity))) {
                ...
                Alien.LOGGER.info(
                    "Hive2: queenless leader {} re-joined lineage {} after cocoon transition",
                    leaderId,
                    lineageId
                );
            }
        ...
        location.setQueenlessMaturationLastAdvanceTick(currentTick);
        Alien.LOGGER.info(
            "Hive2: queenless maturation advanced leader {} ({}) → {} (lineage {}); growth result {}",
            leaderId,
