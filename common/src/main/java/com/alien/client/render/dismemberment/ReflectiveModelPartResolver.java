 ...
 * {@code ModelPartResolverRegistry} for any model class whose private fields follow the convention.
 */
public final class ReflectiveModelPartResolver {
     ...
     */
    public static <M extends EntityModel<?>> com.blib.api.client.render.v1.dismemberment.ModelPartResolver<M> resolverFor(
        Class<M> modelClass
    ) {
