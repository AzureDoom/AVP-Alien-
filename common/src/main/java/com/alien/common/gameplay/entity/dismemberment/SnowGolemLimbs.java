...
public final class SnowGolemLimbs {
    ...
    private static LimbDefinition head() {
        return LimbDefinition.builder(
            AlienResources.location("snow_golem_head"),
            "head",
            LimbCategories.HEAD
        )
            .spawnAtEyeHeight()
    ...
    private static LimbDefinition upperBody() {
        ...
        return LimbDefinition.builder(
            AlienResources.location("snow_golem_upper_body"),
            "upper_body",
            LimbCategories.HEAD
        )
    ...
    private static LimbDefinition rightArm() {
        return LimbDefinition.builder(
            AlienResources.location("snow_golem_right_arm"),
            "right_arm",
            LimbCategories.ARM
        )
            .renderRotation(90.0, 0.0, 0.0)
    ...
    private static LimbDefinition leftArm() {
        return LimbDefinition.builder(
            AlienResources.location("snow_golem_left_arm"),
            "left_arm",
            LimbCategories.ARM
        )
            .renderRotation(90.0, 0.0, 0.0)
