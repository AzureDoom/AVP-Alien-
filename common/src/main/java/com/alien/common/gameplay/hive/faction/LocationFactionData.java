...
/**
 * Per-{@link com.alien.common.gameplay.hive.location.HiveLocation} faction. The faction id equals the location's
 ...
 * {@link com.alien.common.gameplay.hive.location.HiveLocation}.
 * <p>
...
public class LocationFactionData extends FactionData {
    ...
    public void onMemberAdded(FactionMember member, Entity entity) {
        ...
        if (mismatch || notInLineage) {
            Alien.LOGGER.warn(
                "Hive: evicting {} from location faction {} — variantMatch={}, inParentLineage={} (lineage={}, variant={})",
                entity.getUUID(),
                locationId,
                !mismatch,
                !notInLineage,
