...
public class ChrysalisCombatActions {

    public static final Action<Xenomorph> MOVE_TO_TARGET = BLibAction.<Xenomorph>builder("ChrysalisMoveToTargetAction")
    ...
    private ChrysalisCombatActions() {
