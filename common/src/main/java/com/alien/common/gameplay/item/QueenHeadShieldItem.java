...
/**
 * The shield variant crafted from a {@link QueenHeadItem} + vanilla shield. Pure shield behavior — held to
 * block, takes durability damage on block, can be disabled by axes / explosions / shield-disabling
 * attacks. Not wearable (no head slot) and not placeable (no block form). Conversion is one-way: there's
 * no recipe to revert this back into a wearable {@link QueenHeadItem}.
 */
