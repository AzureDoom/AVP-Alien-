...
public class AlienSpawnEggItems {
    ...
    public static final AVPDeferredHolder<Item> ABERRANT_ADOLESCENT_SPAWN_EGG = register(
        "aberrant_adolescent",
    ...
    public static final AVPDeferredHolder<Item> ABERRANT_BOILER_SPAWN_EGG = register(
        "aberrant_boiler",
    ...
    public static final AVPDeferredHolder<Item> ABERRANT_CRUSHER_SPAWN_EGG = register(
        "aberrant_crusher",
    ...
    public static final AVPDeferredHolder<Item> ABERRANT_PREDALIEN_ADOLESCENT_SPAWN_EGG = register(
    ...
    public static final AVPDeferredHolder<Item> ABERRANT_PREDALIEN_CHESTBURSTER_SPAWN_EGG = register(
    ...
    public static final AVPDeferredHolder<Item> ABERRANT_PREDALIEN_SPAWN_EGG = register(
        "aberrant_predalien",
    ...
    public static final AVPDeferredHolder<Item> ABERRANT_PROWLER_SPAWN_EGG = register(
        "aberrant_prowler",
    ...
    public static final AVPDeferredHolder<Item> ABERRANT_RUNNER_SPAWN_EGG = register(
        "aberrant_runner",
    ...
    public static final AVPDeferredHolder<Item> ABERRANT_SPITTER_SPAWN_EGG = register(
        "aberrant_spitter",
    ...
    public static final AVPDeferredHolder<Item> ADOLESCENT_SPAWN_EGG = register(
        "adolescent",
    ...
    public static final AVPDeferredHolder<Item> BOILER_SPAWN_EGG = register(
        "boiler",
    ...
    public static final AVPDeferredHolder<Item> CRUSHER_SPAWN_EGG = register(
        "crusher",
    ...
    public static final AVPDeferredHolder<Item> DRONE_SPAWN_EGG = register(
        "drone",
    ...
    public static final AVPDeferredHolder<Item> IRRADIATED_CRUSHER_SPAWN_EGG = register(
        "irradiated_crusher",
    ...
    public static final AVPDeferredHolder<Item> IRRADIATED_PREDALIEN_SPAWN_EGG = register(
    ...
    public static final AVPDeferredHolder<Item> IRRADIATED_PROWLER_SPAWN_EGG = register(
        "irradiated_prowler",
    ...
    public static final AVPDeferredHolder<Item> IRRADIATED_RUNNER_SPAWN_EGG = register(
        "irradiated_runner",
    ...
    public static final AVPDeferredHolder<Item> NETHER_ADOLESCENT_SPAWN_EGG = register(
        "nether_adolescent",
    ...
    public static final AVPDeferredHolder<Item> NETHER_BOILER_SPAWN_EGG = register(
        "nether_boiler",
    ...
    public static final AVPDeferredHolder<Item> NETHER_CRUSHER_SPAWN_EGG = register(
        "nether_crusher",
    ...
    public static final AVPDeferredHolder<Item> NETHER_PREDALIEN_ADOLESCENT_SPAWN_EGG = register(
    ...
    public static final AVPDeferredHolder<Item> NETHER_PREDALIEN_CHESTBURSTER_SPAWN_EGG = register(
    ...
    public static final AVPDeferredHolder<Item> NETHER_PREDALIEN_SPAWN_EGG = register(
        "nether_predalien",
    ...
    public static final AVPDeferredHolder<Item> NETHER_PROWLER_SPAWN_EGG = register(
        "nether_prowler",
    ...
    public static final AVPDeferredHolder<Item> NETHER_RUNNER_SPAWN_EGG = register(
        "nether_runner",
    ...
    public static final AVPDeferredHolder<Item> NETHER_SPITTER_SPAWN_EGG = register(
        "nether_spitter",
    ...
    public static final AVPDeferredHolder<Item> PREDALIEN_ADOLESCENT_SPAWN_EGG = register(
    ...
    public static final AVPDeferredHolder<Item> PREDALIEN_CHESTBURSTER_SPAWN_EGG = register(
    ...
    public static final AVPDeferredHolder<Item> PREDALIEN_SPAWN_EGG = register(
        "predalien",
    ...
    public static final AVPDeferredHolder<Item> PROWLER_SPAWN_EGG = register(
        "prowler",
    ...
    public static final AVPDeferredHolder<Item> QUEEN_SPAWN_EGG = register(
        "queen",
    ...
    public static final AVPDeferredHolder<Item> ROYAL_ABERRANT_ADOLESCENT_SPAWN_EGG = register(
    ...
    public static final AVPDeferredHolder<Item> ROYAL_ADOLESCENT_SPAWN_EGG = register(
        "royal_adolescent",
    ...
    public static final AVPDeferredHolder<Item> ROYAL_NETHER_ADOLESCENT_SPAWN_EGG = register(
    ...
    public static final AVPDeferredHolder<Item> RUNNER_SPAWN_EGG = register(
        "runner",
    ...
    public static final AVPDeferredHolder<Item> SPITTER_SPAWN_EGG = register(
        "spitter",
    ...
    public static final AVPDeferredHolder<Item> WARRIOR_SPAWN_EGG = register(
        "warrior",
